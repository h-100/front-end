...
function SubCard( {topText, midText, svgImg} ) {
  ...
  <div className="self-stretch flex flex-col justify-center items-center">
    <div className="justify-start text-white text-5xl font-normal font-['Core_Sans_D_35_Regular']">{topText}</div>
    <div className="text-center justify-start text-white text-2xl font-normal font-['PP_Neue_Montreal'] leading-10">{midText}</div>
  </div>
  <div className="">
