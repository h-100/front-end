  ...
  return (
    <>
      <div className="flex justify-center mt-[60px]">
        <div className="self-stretch h-14 mtext-center justify-center text-red-950 text-6xl font-medium font-['PP_Neue_Montreal'] leading-[60px]">
          Find leads that respond
        </div>
      </div>

      <div className="flex justify-center">
        <div className="mt-[16px] w-[590px] text-center justify-start text-black text-lg font-normal font-['Core_Sans_D_35_Regular'] leading-tight mt-[16px]">
          Accelerate growth with verified emails and mobile numbers - 250M leads
