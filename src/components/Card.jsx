...
export default function Card() {
  return (
    <div
      className="w-[1193px] bg-black p-8 rounded-xl shadow-lg"
      style={{ backgroundImage: `url(${backgroundRed})` }}
    >
      <div className="text-center mb-8">
        <div className="self-stretch text-center justify-start text-white text-4xl font-normal font-['PP_Neue_Montreal'] leading-[60px]">
          “27% Increase in positive reply”
        </div>

        <div className="self-stretch text-center justify-start text-white text-xl font-normal font-['Core_Sans_D_35_Regular'] leading-snug">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-[23px] w-[1116px] h-[205px];">
        <SubCard
          topText="55%"
          midText="Pick up rate on mobiles"
          svgImg={mobileIcon}
        ></SubCard>
        <SubCard
          topText="55M"
          midText="Verified Email Addresses"
          svgImg={emailIcon}
        ></SubCard>
        <SubCard
          topText="98%"
          midText="Data Accuracy"
          svgImg={dataAccuracyIcon}
        ></SubCard>
      </div>
    </div>
  )
