...
export default function Page() {
  return (
   ...
   <div className="w-full h-[789px] rounded-[20px] m-[29.5px] bg-no-repeat"
   ...
   <div className="justify-start text-red-950 text-5xl font-medium font-['PP_Neue_Montreal'] leading-[50px] text-center">Integrate into any workflow</div>
   </div>
   ...
   <div className="justify-start text-red-950 text-5xl font-medium font-['PP_Neue_Montreal'] leading-[50px] text-center py-[80px]">Cases Study</div>
...
><span class="text-red-950 text-5xl font-medium font-['PP_Neue_Montreal'] leading-[50px]">Meet the companies generating more revenues with </span><span class="text-red-600 text-5xl font-medium font-['PP_Neue_Montreal'] leading-[50px]">Prospeo</span></div> 
