...
function Navbar() {
  return (
    <div className="flex justify-center">
      <nav
        className="flex items-center justify-between w-[1121px] h-[65px] rounded-[7px] bg-white p-[20px] shadow-[0px_0.78px_3.11px_0px_rgba(0,0,0,0.05)] shadow-[0px_6.99px_15.85px_0px_rgba(0,0,0,0.05)] mt-[22px]
    "
      >
        <div className="flex items-center space-x-[10px] rounded-[7px]">
          <img src={companyIcon} alt="icon" className="w-8 h-8" />
          <span className="text-xl font-bold text-[#EF1515]">Prospeo</span>
        </div>
